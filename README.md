...
Web3TV is a decentralized movie platform built on the **Pharos Blockchain**, developed during the **Pharos Hackathon**. The platform offers a secure and fair way to upload, purchase, and watch movies using blockchain and NFT technology. 

## Key Features

### Admin Side
1. **Movie Encryption & Upload:** Movies are encrypted using **CryptoJS** for added security and uploaded to the **IPFS** network.
2. **Blockchain Integration:** Metadata and movie details are stored on the **Pharos Chain** after a transaction confirmation via MetaMask.
...
3. **Chatbot Integration:** A chatbot powered by **GEMINI** is integrated to assist users with detailed information about movies, ensuring an engaging experience.
...
- Defined the project concept and finalized the use of **Pharos Chain** and **IPFS**.
...
- Integrated a **GEMINI** to provide movie-related information to users.
...
1. **Uploading a Movie:**
   ...
   - MetaMask is used to confirm the transaction, and the movie details are stored on the **Pharos**.
...
4. **Chatbot Assistance:**
   - Users can interact with the **Gemini** to get detailed information about movies, including genres, cast, and ratings.

## Tech Stack
- **Blockchain:** Pharos Chain
- **Storage:** IPFS
- **Encryption:** CryptoJS
